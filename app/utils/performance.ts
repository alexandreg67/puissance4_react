...
export const getDeviceCapabilities = () => {
  ...
  return {
    ...
    supportsGPUAcceleration: 'webkitBackfaceVisibility' in document.documentElement.style,
    memoryLevel: deviceMemory >= 8 ? 'high' : deviceMemory >= 4 ? 'medium' : 'low' as const,
  };
};
...
export const optimizeForPerformance = {
  ...
  getAnimationConfig() {
    ...
    const shouldReduceMotion = PerformanceMonitor.getInstance().shouldUseReducedMotion();
